...
const GroupDetails = ({ group, onClose }) => {
  return (
    ...
    >
      <div
        className="bg-white py-8 px-12  rounded-2xl shadow-lg w-2/5 font-roboto"
      ...
      >
            ...
            <ul className="space-y-2">
              {group.skills.map((skill, index) => (
                <li key={index} className="font-fragment ">
                  <div className="font-fragment border-[#46464640] text-[#464646] border rounded-full px-4 text-center">
                    {skill}
                  </div>
                </li>
              ))}
        ...
        <div className="flex justify-end mt-4">
          <button className="bg-[#00a99b] w-1/3 text-white py-2 px-6 rounded-full hover:bg-[#008e8a] active:bg-[#006f6b] focus:outline-none focus:ring-2 focus:ring-[#00a99b]">
            Join team
          </button>
        </div>
      </div>
